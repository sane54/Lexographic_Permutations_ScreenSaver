 ...
 * @author Owner
 */
public class screensaver_try2 extends JFrame implements ActionListener {
    
        static int sides = 6;
        static int radius = 90;
        static int initX = 0;
        static int initY = 0;
        static int vpl = 10;
        static int hpl = 20;
        ...
        final void looper() {
            ...
            while (hasNext(a)) {
                ...
                try {
                    ...
                    Logger.getLogger(screensaver_try2.class.getName()).log(Level.SEVERE, null, ex);
                }
        ...
        void setupPolygons(int [] a) {
            ...
            for (int x_count = 0; x_count < hpl; x_count++) {
                for (int y_count = 0; y_count < vpl; y_count++){
                    ...
                    startingY = startingY + 2*radius - 25;
